...
import { SquarePen, Hash, Image, Eraser, Scissors, FileText,Send,ScrollText } from 'lucide-react'
...
export const AiToolsData = [
    ...
    },
    {
        ...
        description: 'Craft engaging and compelling social media posts with our AI-powered content creation.',
        Icon: Send, // Using the 'Send' icon from lucide-react for post generation
        bg: { from: '#FF7F50', to: '#FF6347' }, // Example colors, feel free to adjust
        path: '/ai/generate-post'
    },
    {
        title: 'Content Summarizer',
        description: 'Quickly condense long articles and documents into concise summaries with AI.',
        Icon: ScrollText, // Using the 'ScrollText' icon from lucide-react for summarization
        bg: { from: '#8A2BE2', to: '#4B0082' }, // Example colors, feel free to adjust (Purple tones)
        path: '/ai/summarize-content'
    }
]
