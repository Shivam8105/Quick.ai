...
import { Eraser, FileText, Hash, House, Image, LogOut, Scissors, SquarePen, Users, Send } from 'lucide-react';
...
const navItems = [
  ...
  {to: '/ai/summarize-content', label: 'Summarize Content', Icon: FileText},
  {to: '/ai/generate-post', label: 'Generate Post', Icon: Send},
